...
public class RobotMap {
	...
	public static final int MOTOR_LEFT_SIDE = 2;
	public static final int ENCODER_LEFT_SIDE_A = 4;
	public static final int ENCODER_LEFT_SIDE_B = 5;
	
	public static final int MOTOR_RIGHT_SIDE = 3;
	public static final int ENCODER_RIGHT_SIDE_A = 6;
